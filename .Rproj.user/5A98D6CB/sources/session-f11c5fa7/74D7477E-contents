...
while(i <= nrow(params)){
  ...
  for(j in 1:nrep){
    ...
    tr = read.tree(glue("/Users/sofia/Desktop/Imperial/R_packages/fitMuSSECo/CoalescentJl_simulations/trees/params_{i}/param_{i}_rep_{j}.nwk"))
